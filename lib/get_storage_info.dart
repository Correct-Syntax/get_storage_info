...
class GetStorageInfo {
  ...
  static DeviceStorageType getStorageTypeFromPath(String path) {
    ...
    return path.startsWith('/storage/emulated/0') == true ? DeviceStorageType.internal : DeviceStorageType.external;
  }
  ...
  static Future<bool> getIsLowOnStorage(DeviceStorageType storageType, {double threshold = 0.98}) async {
  ...
  static bool getIsStorageBelowThreshold(double storageUsageValue, double threshold) {
    if (storageUsageValue <= 0.0 || storageUsageValue >= 1.0) {
      throw Exception('storageUsageValue must be within the range of 0.0 and 1.0');
    }
